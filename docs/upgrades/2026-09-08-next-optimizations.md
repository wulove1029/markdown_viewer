...
| 0 | 大型 Markdown 基線量測工具與基線數據 | 進行中 | `2026-09-08-next-baseline.md` |
| 1 | 首頁新增入口 | 進行中（隔離 worktree） | `2026-09-08-next-home-new.md` |
| 2 | 更新下載流程 | 實作完成（未 commit），fresh review 進行中 | `2026-09-08-next-update-download.md` |
| 3 | 大型 Markdown 取消排程與首屏改善 | 待批次 0 | `2026-09-08-next-large-markdown.md` |
